                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <input type="name" className="form-control" placeholder="Name" value={this.state.username} onChange={e => this.setState({username: e.target.value})} />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <input type="password" className="form-control" placeholder="Password (Again)" value={this.state.passwordAgain} onChange={e => this.setState({passwordAgain: e.target.value})} />
                                        </div>
                                    </div>
                                </div>
